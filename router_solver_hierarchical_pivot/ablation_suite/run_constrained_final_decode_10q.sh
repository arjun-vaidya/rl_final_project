...
OUT_DIR="${OUT_DIR:-$ROOT_DIR/experiments/constrained_final_decode_10q}"
...
run_variant sota_baseline
run_variant constrained_final_decode --constrained-final-answer-decoding on
