...
\begin{columns}[T,onlytextwidth]
  \begin{column}{0.33\textwidth}
    \begin{block}{W\&B Loss Chart}
    \includegraphics[width=0.98\linewidth,keepaspectratio]{../../docs/assets/wandb_loss_chart.png}
    \end{block}
  \end{column}
  \begin{column}{0.33\textwidth}
    \begin{block}{W\&B Accuracy Chart}
    \includegraphics[width=0.98\linewidth,keepaspectratio]{../../docs/assets/wandb_accuracy_chart.png}
    \end{block}
  \end{column}
  \begin{column}{0.33\textwidth}
    \begin{block}{W\&B Invalid Ratio Chart}
    \includegraphics[width=0.98\linewidth,keepaspectratio]{../../docs/assets/wandb_invalid_ratio_chart.png}
    \end{block}
  \end{column}
\end{columns}
\end{frame}
...
\end{quote}
\hfill {\tiny\texttt{docs/07\_plan\_memory.md}}
\end{block}
