...
\begin{columns}[T,onlytextwidth]
  \begin{column}{0.33\textwidth}
    \begin{block}{Loss}
    \includegraphics[width=0.98\linewidth,keepaspectratio]{../../docs/assets/challenge10_loss_crop.png}
    \end{block}
  \end{column}
  \begin{column}{0.33\textwidth}
    \begin{block}{Outcome Accuracy}
    \includegraphics[width=0.98\linewidth,keepaspectratio]{../../docs/assets/challenge10_accuracy_crop.png}
    \end{block}
  \end{column}
  \begin{column}{0.33\textwidth}
    \begin{block}{Invalid Plan Ratio}
    \includegraphics[width=0.98\linewidth,keepaspectratio]{../../docs/assets/challenge10_invalid_ratio_crop.png}
    \end{block}
  \end{column}
\end{columns}
\end{frame}
