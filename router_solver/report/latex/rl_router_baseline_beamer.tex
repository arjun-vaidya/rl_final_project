...
\begin{enumerate}\tightitems
  ...
  \vspace{0.5em}
  \item \textbf{RL Training:} Reward design and group size heavily impact convergence. Evaluation cost dominates. Process vs. outcome rewards need careful balance.
\end{enumerate}
\end{frame}
